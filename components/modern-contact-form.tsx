    ...
    <div className="bg-purple-800/30 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-purple-700/50">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="name" className="block text-purple-200 mb-3 font-medium flex items-center">
          ...
          <div>
            <label htmlFor="email" className="block text-purple-200 mb-3 font-medium flex items-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="company" className="block text-purple-200 mb-3 font-medium flex items-center">
          ...
          <div>
            <label htmlFor="phone" className="block text-purple-200 mb-3 font-medium flex items-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="budget" className="block text-purple-200 mb-3 font-medium flex items-center">
        ...
        {/* Message */}
        <div>
          <label htmlFor="message" className="block text-purple-200 mb-3 font-medium flex items-center">
