        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <div className="bg-purple-800/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-700/50 hover:border-purple-500/50 transition-all duration-200 hover:scale-105 group">
              <Phone className="w-12 h-12 text-purple-400 mb-4 mx-auto group-hover:scale-110 transition-transform duration-200" />
              <h3 className="text-xl font-bold text-white mb-2">Call Us</h3>
              <p className="text-purple-200 text-sm">+92 301 0219324</p>
              <p className="text-purple-300 text-xs mt-1">Mon-Fri 9AM-6PM PST</p>
            </div>
            <div className="bg-purple-800/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-700/50 hover:border-purple-500/50 transition-all duration-200 hover:scale-105 group">
              <Mail className="w-12 h-12 text-pink-400 mb-4 mx-auto group-hover:scale-110 transition-transform duration-200" />
              <h3 className="text-xl font-bold text-white mb-2">Email Us</h3>
              <p className="text-purple-200 text-sm">mtinternational139@gmail.com</p>
              <p className="text-purple-300 text-xs mt-1">Response Within 2-4 Hours</p>
            </div>
            <div className="bg-purple-800/30 backdrop-blur-sm rounded-2xl p-6 border border-purple-700/50 hover:border-purple-500/50 transition-all duration-200 hover:scale-105 group">
              <MessageCircle className="w-12 h-12 text-blue-400 mb-4 mx-auto group-hover:scale-110 transition-transform duration-200" />
